            ...
            <div class="detail-section">
                <div class="club-grid">
                    ...
                    <div class="club-card inactive">
                        <div class="club-emoji"><img src = "../images/mypage/basket.png" alt = "운동부"></div>
                        <div class="club-name">운동부</div>
                        <div class="join-date">미가입</div>
                    </div>
                    
                    <div class="club-card inactive">
                        <div class="club-emoji"><img src = "../images/mypage/school.png" alt = "선도부"></div>
